                        ...
                        child: Column(children: [
                          ...
                          Container(
                            child: Column(
                              children: [
                                ElevatedButton(
                                  style: ElevatedButton.styleFrom(fixedSize: Size(250, 60), backgroundColor: Colors.white),
                                  onPressed: () async {
                                    await MyUrl.launchURL(MyStrings.weatherNowLink);
                                  },
                                  child: Image.asset(
                                ...
                                SizedBox(height: 10),
                                ElevatedButton(
                                  style: ElevatedButton.styleFrom(padding: EdgeInsets.all(12), fixedSize: Size(250, 56), backgroundColor: Colors.white),
                                  onPressed: () {},
                                  child: Image.asset(
