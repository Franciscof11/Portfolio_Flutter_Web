...
class PublishedProjectTile extends StatelessWidget {
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  ElevatedButton(
                                      ...
                                      onPressed: () async {
                                        await MyUrl.launchURL(appleStoreLink);
                                      },
                                      child: Padding(
                                  ...
                                  ElevatedButton(
                                      style: ElevatedButton.styleFrom(fixedSize: Size(200, 50), backgroundColor: Colors.white),
                                      onPressed: () async {
                                        await MyUrl.launchURL(playStoreLink);
                                      },
                                      child: Padding(
                                        padding: const EdgeInsets.all(8.0),
                                        child: Row(
                                          children: [
                                            Image.asset(
                                              'assets/icons/playstore_logo.png',
                                            ),
                                            SizedBox(width: 8),
                                            Text(
                                              'Play Store',
